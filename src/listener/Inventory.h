...
class Inventory {
    ...
    static Tower createT1(float damageDealt, float timerFrame, Rectangle &hitbox, int speed,const std::string &id,const Texture2D &image,Vector2 center,float radius, const std::vector<Projectile> &projectiles)
    ...
    static Tower createT2(float damageDealt, float timerFrame, Rectangle &hitbox, int speed, const std::string &id,const Texture2D &image,Vector2 center,float radius, const std::vector<Projectile> &projectiles)
    ...
    static Tower createT3(float damageDealt, float timerFrame, Rectangle &hitbox, int speed, const std::string &id,const Texture2D &image,Vector2 center,float radius, const std::vector<Projectile> &projectiles)
    ...
    static Tower createT4(float damageDealt, float timerFrame, Rectangle &hitbox, int speed, const std::string &id,const Texture2D &image,Vector2 center,float radius, const std::vector<Projectile> &projectiles)
    ...
    static Tower createT5(float damageDealt, float timerFrame, Rectangle &hitbox, int speed, const std::string &id,const Texture2D &image,Vector2 center,float radius, const std::vector<Projectile> &projectiles)
